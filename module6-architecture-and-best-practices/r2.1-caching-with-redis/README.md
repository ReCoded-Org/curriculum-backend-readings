...
In the second request, this time our API knows that the data exists in cache so it reads it directly from there. As a result, the response time is reduced to about 270 ms.
...
Here are some more code examples for implemting Redis-based caching in Node.js.
